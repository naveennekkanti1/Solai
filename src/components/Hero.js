...
const Hero = () => {
  ...
  useEffect(() => {
    // Keep the phrases inside the effect so the dependency
    // array does not change on every render.
    const phrases = [
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `https://violent-stacey-solai-aba6a507.koyeb.app/newsletter/subscribe?email=${encodeURIComponent(
          email
        )}`,
        {
          method: "POST",
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
            ...
            <div>
              ...
              <p className="text-gray-400 leading-relaxed mb-6">
                Empowering businesses through innovative AI solutions that
              ...
              <div className="flex gap-4">
                ...
                <a
                  ...
                  className="w-9 h-9 bg-[#2a3142] hover:bg-red-600 rounded flex items-center justify-center transition-colors"
                  aria-label="LinkedIn"
                >
                  <Linkedin size={18} />
                </a>
            ...
            <div>
              ...
              <p className="text-gray-400 mb-5 leading-relaxed">
                Stay updated with the latest in AI technology and business
                solutions.
              </p>
