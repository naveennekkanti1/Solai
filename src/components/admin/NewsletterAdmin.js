...
<div class="container">
  ...
  <div class="content">
    ...
    <p>
      Welcome to this week's edition of SolAI insights!
    </p>
    ...
    <div class="article">
      ...
      <ul>
        <li>
          New AI technologies revolutionizing industries
        </li>
  ...
  <div class="footer">
    ...
    <p>
      © 2024 SolAI. All rights reserved.
    </p>
...
<div class="container">
  ...
  <div class="ann-box">
    ...
    <div class="ann-body">
      ...
      <h2 class="ann-title">
        SolAI 2.0 is Here —
        The Future of AI Just Got Closer
      </h2>

      <p class="ann-desc">
        Smarter insights, faster automation,
        and deeper integrations.
      </p>

      <a href="#" class="ann-cta">
        Explore What's New &rarr;
      </a>
...
const NewsletterAdmin = () => {
    ...
    async () => {
      ...
      try {
        const response = await fetch(
          "https://violent-stacey-solai-aba6a507.koyeb.app/newsletter/subscribers"
        );
  ...
  const loadTemplate = (key) => {
    ...
    showMessage(
      `${key.charAt(0).toUpperCase() + key.slice(1)} template loaded`,
      "success"
    );
  };
  ...
  const handleSendNewsletter = async () => {
    ...
    try {
      const response = await fetch(
        "http://localhost:8081/newsletter/send-weekly",
        {
          method: "POST",
                ...
                {[
                  ...
                  ({
                    ...
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg transition text-sm font-medium ${cls} ${
                        activeTemplate === key
                          ? activeCls
                          : ""
                      }`}
