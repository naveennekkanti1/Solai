      ...
      <div className="space-y-2 text-xs">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-gray-600 truncate">
            {consultation.contact_email || 'N/A'}
          </span>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-gray-600">
            {consultation.contact_phone || 'N/A'}
          </span>
        </div>
      </div>
...
const StatusColumn = ({
  ...
  return (
    ...
    >
      <div
        className={`bg-gradient-to-r ${colorClasses[color]} text-white rounded-xl p-4 mb-4 shadow-lg`}
      >
          ...
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-5 border border-blue-100">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <span className="text-sm font-medium text-gray-500 uppercase block">
                    Email
                  </span>
                  <a
                    href={`mailto:${consultation.contact_email}`}
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a
                    href={`tel:${consultation.contact_phone}`}
...
const ConsultationsAdmin = () => {
  ...
  const fetchConsultations = useCallback(async () => {
    ...
    try {
      const response = await fetch(
        'https://violent-stacey-solai-aba6a507.koyeb.app/consultation/all'
      );
  ...
  const handleDrop = async (e, newStatus) => {
    ...
    try {
      const response = await fetch(
        `https://violent-stacey-solai-aba6a507.koyeb.app/consultation/update-status/${draggedItem.id}`,
        {
          method: 'PUT',
          headers: {
      ...
      if (response.ok) {
        ...
        showMessage(
          `Consultation moved to ${newStatus}`,
          'success'
        );
      } else {
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-gray-600 mt-2">
                Drag and drop consultations to change their status
              </p>
            </div>
